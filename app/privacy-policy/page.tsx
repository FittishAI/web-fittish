      ...
      <div className="pt-20 pb-8 bg-gray-50">
        <div className="container">
          ...
          <div className="prose prose-gray max-w-none mt-12">
            <h2>Introduction</h2>
            <p>
            Fittish (the "App") is a mobile application that provides personalized fitness recommendations, including workouts, meal plans, and sleep schedules. We are committed to protecting your privacy and safeguarding your personal information. This Privacy Policy explains what information we collect through Fittish, how we use and share that information, and the choices you have regarding your data. By using Fittish, you agree to the collection and use of your information as described in this Privacy Policy. If you do not agree with our practices, please do not use the App. This policy applies to information collected through our mobile application and any related services, features, or content we provide.            </p>

            <h2>Information We Collect</h2>
            <p>We collect various types of information to provide and improve our services. This includes information you provide directly, information collected automatically, and information from third parties. The types of information we may collect include:    </p>
            <ul>
              <li><strong>Account and Contact Info:</strong> When you register or fill out a contact form, we collect personal details such as your name, email address, username, and password. This also includes any contact information you provide when reaching out to us for support or inquiries.              </li>
              <li><strong>Fitness Info:</strong>  You may provide information about your fitness profile, goals, and preferences. This can include data such as your fitness goals (e.g. weight loss, muscle gain), workout preferences, dietary restrictions, age, weight, height, and other health or wellness information you choose to share. Providing this information is optional but enables us to tailor recommendations to you.</li>
              ...
              <li><strong>Communications:</strong>  If you contact us directly (for example, via email, support chat, or a contact form), we will receive the information you provide in your message. This may include your name, email address, and the content of your communication. We retain these communications to respond to your inquiries and improve our services.              </li>
              <li><strong>Payment Info:</strong>  If you make a purchase or subscribe to a premium service through Fittish, we (or our third-party payment processor) may collect information related to your purchase. This can include your payment method details (such as credit card type, expiration date, and billing address) and transaction details. Note: We do not store full credit card numbers or financial account information on our servers; such data is handled securely by our payment processing partners.</li>
              <li><strong>Third-Party Services:</strong>  Fittish may allow you to connect with third-party services (for example, signing in via Google/Apple ID or linking to a fitness tracker). If you choose to connect a third-party account or service, we may receive certain information from that provider (such as your name, email, or profile information from a social login, or exercise/health data from a connected device). We will handle any information received from third parties in accordance with this Privacy Policy.</li>
            </ul>
            ...
            <ul>
              ...
              <li>Send updates, respond to support requests</li>
            ...
            <ul>
              ...
              <li>We share data only with services that help run the app (analytics, payments, hosting)</li>
              <li>We may share with law enforcement when legally required</li>
              <li>In the case of a merger or acquisition, data may be transferred securely</li>
              <li>We may share de-identified or aggregated data for research or reporting</li>
            </ul>
            ...
            <h2>Contact Us</h2>
            <p>
              Email: <strong>privacy@fittishapp.com</strong><br />
              Mail: Fittish Privacy Team, 123 Fitness Avenue, Suite 100, Wellness City, CA 90210, USA
            </p>
          </div>
        </div>
      </div>
