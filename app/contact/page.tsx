              ...
              <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
                ...
                <form className="mt-8 space-y-6">
                  ...
                  <div>
                    <button
                      type="submit"
                      className="w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all duration-300 hover:scale-[1.02]"
                    >
                      Send Message
                    </button>
                  </div>
          ...
          <div className="text-center">
            <Reveal>
              ...
              <div className="mt-8 flex flex-wrap justify-center gap-4">
                <a
                  href="#"
                  className="btn bg-white text-indigo-600 hover:bg-indigo-50 transition-all duration-300 hover:scale-105"
                >
                  Start Free Trial
                </a>
                <a
                  href="#"
                  className="btn bg-indigo-500 text-white border border-indigo-400 hover:bg-indigo-700 transition-all duration-300 hover:scale-105"
                >
                  Schedule Demo
                </a>
              </div>
